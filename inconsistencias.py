...
df['idade_ajustada'] = df['idade_ajustada'] - ((data_atual.month < df['data_atualizada'].dt.month) & (data_atual.day < df['data_atualizada'].dt.day)).astype(int)
